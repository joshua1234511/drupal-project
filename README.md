...
[![CI](https://github.com/joshua1234511/drupal-project/actions/workflows/ci.yml/badge.svg?branch=9.x)](https://github.com/joshua1234511/drupal-project/actions/workflows/ci.yml)
...
```
composer create-project joshua1234511/drupal-project:9.x some-dir --no-interaction
```
...
* Drupal will be installed in the `root`-directory.
...
1. Commit everything all together in a single commit, so `/` will remain in
...
/ directory of your project. If you have not customized those files you could
